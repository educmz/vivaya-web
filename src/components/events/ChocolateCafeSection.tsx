      ...
      <div className="mx-auto w-full max-w-[1160px] px-5 sm:px-8 lg:px-10">
        <div className="grid items-center gap-7 md:grid-cols-2 lg:gap-10">
          ...
          <div className="min-w-0 max-w-xl">
            ...
            {/* DETALLES */}
            <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 border-t border-[#E6DDD5] pt-4">
              ...
              <div className="flex items-center gap-2 text-xs text-[#6F6962]">
                <Store className="h-4 w-4 text-[#FF8A00]" />
                Carrito temático
              </div>

              <div className="flex items-center gap-2 text-xs text-[#6F6962]">
                <UserRound className="h-4 w-4 text-[#FF8A00]" />
                Personal de atención
              </div>

              <div className="flex items-center gap-2 text-xs text-[#6F6962]">
                <Coffee className="h-4 w-4 text-[#FF8A00]" />
                Café e infusiones
              </div>
            </div>
            ...
            <a
              ...
              className="mt-5 inline-flex min-h-11 items-center justify-center rounded-full bg-[#FF8A00] px-7 py-3 text-sm font-semibold text-white transition hover:scale-[1.02] hover:bg-[#F57F00]"
            >
