  ...
  return (
    <div className="w-full pb-6 sm:pb-8 lg:pb-10">
      <div className="relative isolate flex h-[clamp(220px,52vw,320px)] w-full items-center overflow-hidden md:h-[clamp(160px,33.33vw,480px)]">
        ...
        <div className="relative z-10 w-3/5 pl-[max(12px,calc((100vw-1280px)/2+12px))] pr-3 sm:pl-[max(24px,calc((100vw-1280px)/2+24px))] md:w-1/2 md:pr-2 lg:pl-[max(40px,calc((100vw-1280px)/2+40px))]">
