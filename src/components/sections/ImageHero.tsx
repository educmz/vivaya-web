  ...
  return (
    <div className="w-full py-6 sm:py-8 lg:py-10">
      <div className="relative isolate flex h-[clamp(160px,33.33vw,480px)] w-full items-center overflow-hidden">
        <Image src={image} alt="" fill priority sizes="100vw" className="z-0 object-cover object-center" />
        <div className="relative z-10 w-1/2 pl-[max(12px,calc((100vw-1280px)/2+12px))] pr-2 sm:pl-[max(24px,calc((100vw-1280px)/2+24px))] lg:pl-[max(40px,calc((100vw-1280px)/2+40px))]">
