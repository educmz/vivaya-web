...
export function ContactForm() {
  ...
  return (
    <section className="relative overflow-hidden bg-background py-20 text-[#302E2A] sm:py-28">
      ...
      <Container className="relative">
        ...
        >
          <label className="grid gap-2 text-sm font-bold">
            Nombre
            <input className="min-h-12 rounded-xl border-2 border-[#302E2A]/20 bg-background px-4 font-normal text-[#302E2A] outline-none placeholder:text-[#302E2A]/40 focus:border-[#FF8A00]" name="name" autoComplete="name" placeholder="Tu nombre" />
          </label>
          <label className="grid gap-2 text-sm font-bold">
            Correo
            <input className="min-h-12 rounded-xl border-2 border-[#302E2A]/20 bg-background px-4 font-normal text-[#302E2A] outline-none placeholder:text-[#302E2A]/40 focus:border-[#FF8A00]" name="email" type="email" autoComplete="email" placeholder="tucorreo@ejemplo.com" />
          </label>
          <label className="grid gap-2 text-sm font-bold">
            Mensaje
            <textarea className="min-h-36 rounded-xl border-2 border-[#302E2A]/20 bg-background p-4 font-normal text-[#302E2A] outline-none placeholder:text-[#302E2A]/40 focus:border-[#FF8A00]" name="message" placeholder="Escribe tu mensaje" />
          </label>
