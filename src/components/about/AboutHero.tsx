...
export function AboutHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#FFF7E8] text-[#073B3A]">
      <Container className="relative grid min-h-[68svh] items-center gap-8 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
        {/* TEXTO */}
        <div className="relative z-20">
          <h1 className="mt-6 max-w-[15ch] font-accent text-[clamp(4rem,9vw,9.5rem)] leading-[0.95] text-[#073B3A]">
            <motion.span
              className="block"
            ...
            >
              <span className="block overflow-hidden pb-[0.1em]">
                <motion.span
                  ...
                  className="block leading-[0.95] text-[#FF8A00]"
                >
                  lo natural.
                </motion.span>
              </span>
          ...
          >
            <p className="max-w-sm text-base font-normal leading-7 text-[#073B3A]/68 sm:text-lg">
              Frescura, energía y bienestar pensados para acompañar el
          ...
          >
            ...
            >
              <Image
                ...
                className="object-contain drop-shadow-[0_30px_45px_rgba(7,59,58,0.25)]"
              />
            </motion.div>
          </motion.div>
...
function AboutTicker() {
  ...
  return (
    <div className="overflow-hidden border-y border-[#073B3A]/15 bg-[#FF8A00] py-4 text-[#073B3A]">
      <motion.div
        animate={{
          x: ["0%", "-50%"],
        }}
